...
void Usart3_Configuration(int baud);															//串口3硬件配置
void Usart3_Nvic_Configuration(void);															//串口3中断配置
void Uart4_Configuration(int baud);																//串口4硬件配置
void Uart4_Nvic_Configuration(void);															//串口4中断配置
void Uart5_Configuration(int baud);																//串口5硬件配置
void Uart5_Nvic_Configuration(void);															//串口5中断配置
