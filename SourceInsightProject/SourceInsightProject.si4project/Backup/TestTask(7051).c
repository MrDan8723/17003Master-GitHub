...
//检测块0任务
//任务优先级
#define TEST0_TASK_PRIO		8
//任务堆栈大小	
#define TEST0_STK_SIZE 		512
//任务控制块
OS_TCB Test0TaskTCB;
//任务堆栈	
...
//检测块1任务
//任务优先级
#define TEST1_TASK_PRIO		8
//任务堆栈大小	
#define TEST1_STK_SIZE 		512
//任务控制块
OS_TCB Test1TaskTCB;
//任务堆栈	
...
//检测块11任务
//任务优先级
#define TEST11_TASK_PRIO		8
//任务堆栈大小	
#define TEST11_STK_SIZE 		512
//任务控制块
...
void TT_Test(u8 test_num, TestMsgStruct *test_msg)
{
  ...
  u16 delay;
  TestReagentEnum reagent;      //测试所使用的试剂
